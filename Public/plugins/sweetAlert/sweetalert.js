!(function (e, t) {
    ...
    const N = { previousBodyPadding: null },
        ...
        de = (e, t) => {
            ...
            i.reverseButtons && (i.toast ? (n.insertBefore(r, s), n.insertBefore(a, s)) : (n.insertBefore(r, o), n.insertBefore(a, o), n.insertBefore(s, o))),
                U(c, t.loaderHtml),
                R(c, t, "loader");
        };
    function pe(e, t, n) {
    ...
    const me = (e, t) => {
        ...
        ((o = i),
            ...
            (o = i),
            (n = t.position) in h ? K(o, h[n]) : (a('The "position" parameter is not valid, defaulting to "center"'), K(o, h.center)),
            (n = i),
    ...
    (Ce.text = Ce.email = Ce.password = Ce.number = Ce.tel = Ce.url = (e, t) => (
        "string" == typeof t.inputValue || "number" == typeof t.inputValue ? (e.value = t.inputValue) : p(t.inputValue) || a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
            ve(e, e, t),
            ye(e, t),
            (e.type = t.input),
            e
    ...
    const ke = (e, t) => {
            ...
            return n && t.icon === n.icon
                ...
                : t.icon || t.iconHtml
                    ? t.icon && -1 === Object.keys(f).indexOf(t.icon)
                        ? (r('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), $(e))
        ...
        Me = (e, t) => {
            var n = b();
            const o = w();
            t.toast ? (J(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(T(), C())) : J(o, "width", t.width),
    ...
    const it = () => {
        ...
        rt = (e) => {
            var t,
                ...
                o = b();
            return (
                !(((t = e).touches && t.touches.length && "stylus" === t.touches[0].touchType) || ((e = e).touches && 1 < e.touches.length)) &&
                (n === o || !(ne(o) || "INPUT" === n.tagName || "TEXTAREA" === n.tagName || (ne(A()) && A().contains(n))))
            );
        },
        ct = () => {
            var e;
    ...
    function dt(e, t, n, o) {
        q() ? ht(e, o) : (Fe(n).then(() => ht(e, o)), Ne.keydownTarget.removeEventListener("keydown", Ne.keydownHandler, { capture: Ne.keydownListenerCapture }), (Ne.keydownHandlerAdded = !1)),
    ...
    e = Object.freeze({
        ...
        _main: function (e) {
            ...
            var o,
                ...
                s,
                t = ((e) => {
                    const t = { popup: w(), container: b(), actions: O(), confirmButton: E(), denyButton: S(), cancelButton: L(), loader: T(), closeButton: M(), validationMessage: x(), progressSteps: B() };
        ...
        _destroy: function () {
            ...
            t
                ? (e.popup && Ne.swalCloseEventFinishedCallback && (Ne.swalCloseEventFinishedCallback(), delete Ne.swalCloseEventFinishedCallback),
                Ne.deferDisposalTimer && (clearTimeout(Ne.deferDisposalTimer), delete Ne.deferDisposalTimer),
